---
title: "Pancreatic scRNA-seq analysis of phosphatases-related genes"
...
```{r}
## PHOPSHATASES-RELATED GENES ANALYSIS
...
# 3. Volcano Plot of all genes highlighting phosphatases-related genes
...
# 4. Volcano plot of the phosphatases-related genes
...
volcano_pp2a <- ggplot(goi_results, aes(x = logFC, y = -log10(FDR), color = significance, label = gene)) +
  ...
  labs(
    title = "Phosphatases-related genes - PAAD (pseudobulk)",
    x = "Log2FC (Tumor vs Normal)",
    y = "-Log10(padj)",
    color = "Significance"
  ) +
...
```{r}
# 5. Column bar plots of the significant genes with |log2FC| > 1
